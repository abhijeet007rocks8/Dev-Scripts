...
//     const DELETE = "delete", EDIT = "edit";   //Changes
...
//         income = calculateTotal("income", ENTRY_LIST);
//         outcome = calculateTotal("expense", ENTRY_LIST);
//         balance = Math.abs(calculateBalance(income, outcome));   //-$-2000 to remove negative sign
...
//         clearElement([expenseList, incomeList, allList]);   //REASON??
