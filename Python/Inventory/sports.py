...
def content(root):
        ...
        lbltitle=Label(root,text="Sports",bg="#EEE1C6",fg="#25172d",bd=20,relief=RIDGE,font=("times new roman",50,"bold"),padx=2,pady=6)
        lbltitle.pack(side=TOP,fill=X)

        #===============================ele=================================

        Frameelectronic = LabelFrame(root,text="Sports Wear", bd=12,relief=RIDGE,padx=20,bg="#EEE1C6",font=("times new roman",12,"bold"))
        Frameelectronic.place(x=20,y=200,width=240,height=240)

        buttonviewdetail = Button(root, text="View Details", padx=2, pady=2,bd=10,bg='white',fg='black',font=("times new roman",12,"bold"),command=lambda :viewdetails("sportsw"))
        buttonviewdetail.place(x=75, y=250)
        buttonadd = Button(root, text="QR Code", padx=2, pady=2,bd=10,bg='white',fg='black',font=("times new roman",12,"bold"),command=lambda :qr("sportsw"))
        ...
        #===================================== clothing =========================================
        Frameclothing = LabelFrame(root, text="Gym Equipments", bd=12, relief=RIDGE, padx=20, bg="#EEE1C6",
        ...
        Framegrocery = LabelFrame(root, text="Sports Accessories", bd=12, relief=RIDGE, padx=20, bg="#EEE1C6",
                                  font=("times new roman", 12, "bold"))
